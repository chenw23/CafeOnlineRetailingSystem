...
public class UIConstant_en {
    ...
    public static final String DISCOUNT_CAPPUCCINO = "Cappuccino second half price, discount %f";
    public static final String DISCOUNT_TEA = "Tea buy three send one, discount %f";
