...
public class DoubleElevenStrategyTest {
    ...
    public void testGetDiscountInRMB(){
        ...
        if(isDoubleEleven()){
            assertEquals(14.2,obj.getDiscount(getOrder("rmb")),0.001);
        }else{
            assertEquals(0,obj.getDiscount(getOrder("rmb")),0.001);
        }
    }
    ...
    public void testGetDiscountInHKD(){
        //The test is ugly. When the date is 11-11, the strategy is ok.
        if(isDoubleEleven()){
            assertEquals(15.9,obj.getDiscount(getOrder("hkd")),0.001);
        }else{
            assertEquals(0,obj.getDiscount(getOrder("hkd")),0.001);
        }
    }
